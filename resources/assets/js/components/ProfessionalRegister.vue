        ...
        <div class="header header-blue">
            <div class="container-fluid">
                ...
                <nav class="navbar navbar-expand-md navbar-transparent dark bg-dark">
                    <a class="navbar-brand" href="#"><img src="img/logo_full_white.png" class="mainLogo"></a>
                    ...
                    <div class="collapse navbar-collapse " id="navbarsExampleDefault">
                        <ul class="navbar-nav ml-auto ">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="modal" data-target="#cadastroModal">Cadastrar Consultório</a>
                            </li>
                            <li class="nav-item">
                    ...
                    <div class="bs row">
                        ...
                        <Div class="col-md-12"> <h5 class="subLine">Dados da Conta</h5>
                            <div data-toggle="buttons" class="btn-group btn-group-justified fancy-radio-group">
                                <label class="btn btn-fancy-radio text-xs text-no-transform clearfix"> <img src="images/radio/empty.gif" class="normal"/> <img                  src="images/radio/cked.gif" class="checked" />
                        ...
                        <div class="col-md-6">           <div class="input-group  mtop20">
                        ...
                        <div class="col-md-8">
                            <div class="input-group  mtop20">
                                <div class="input-group-addon"> <i class="fa fa-phone" aria-hidden="true"></i></div>
                                <input type="text" class="form-control"  placeholder="Telefone do Consultório">
                            </div>
                        </div>
                        ...
                        <div class="col-md-8">
                            <div class="input-group  mtop20">
                                <div class="input-group-addon"> <i class="fa fa-phone" aria-hidden="true"></i></div>
                                <input type="text" class="form-control"  placeholder="Telefone do Administrador">
                            </div>
                        </div>
